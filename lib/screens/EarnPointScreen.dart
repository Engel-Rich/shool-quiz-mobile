...
class EarnPointScreenState extends State<EarnPointScreen> {
  ...
  Future<void> showRewardedAd() async{
    ...
    rewardedAd!.show(
      onUserEarnedReward: (AdWithoutView ad, RewardItem reward) {
        ...
        userDBService.updateDocument({UserKeys.points: FieldValue.increment(10)}, appStore.userId).then(
          (value) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:appBarComponent(context: context,title:appStore.translate('lbl_earn_points')),
      body: Stack(
        children: [
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  4.height,
                  Text('${appStore.translate('lbl_points')} ${getIntAsync(USER_POINTS)}', style: boldTextStyle(size: 18, color: colorPrimary)).center(),
                  16.height,
                  Divider(),
                  16.height,
                  Container(
                    ...
                    child: TextButton(
                      child: Text(
                        appStore.translate('lbl_watch_video'),
